        ...
        <?php if ($ismobile == false) { ?>
            ...
            <div class="uk-grid-match uk-grid-divider uk-margin" uk-grid>
                <div class="uk-width-3-4">
                    <a href="kegiatan/<?= $newses[0]['slug'] ?>">
                        <div class="uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover" data-src="/images/kegiatan/<?= $newses[0]['images'] ?>" uk-img></div>
                    </a>
                    <div class="uk-panel uk-margin">
                        <div class="uk-margin uk-child-width-1-2" uk-grid>
                            <div>
                                <h4 class="uk-margin-small">
                                    <a class="uk-link-heading" href="kegiatan/<?= $newses[0]['slug'] ?>"><?= $newses[0]['title'] ?></a>
                                </h4>
                            </div>
                            <div>
                ...
                <div class="uk-width-1-4">
                    <a href="kegiatan/<?= $newses[1]['slug'] ?>">
                        <div class="uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover" data-src="/images/kegiatan/<?= $newses[1]['images'] ?>" uk-img></div>
                    </a>
                    <a class="uk-link-heading" href="kegiatan/<?= $newses[1]['slug'] ?>">
                    ...
                    <div>
                        <div class="uk-panel uk-margin">
                            <a href="kegiatan/<?= $news['slug'] ?>">
                                <div class="uk-height-small uk-flex uk-flex-center uk-flex-middle uk-background-cover" data-src="/images/kegiatan/<?= $news['images'] ?>" uk-img></div>
                            </a>
                            <div class="section-2-title uk-margin-small">
                                <h5 class="uk-margin-small-top uk-margin-remove-bottom">
                                    <a class="uk-link-heading" href="kegiatan/<?= $news['slug'] ?>"><?= $news['title'] ?></a>
                                </h5>
                            </div>
                        ...
                        <div class="uk-panel uk-margin uk-text-center@m">
                            <div class="uk-flex-middle" uk-grid>
                                <div class="uk-flex-last uk-flex-center uk-width-1-2">
                                    <a href="kegiatan/<?= $newses[7]['slug'] ?>">
                                        <div class="uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover" data-src="/images/kegiatan/<?= $newses[7]['images'] ?>" uk-img></div>
                                    </a>
                                </div>
                                <div class="uk-width-expand">
                                    <h4 class="uk-margin-top uk-margin-remove-bottom">
                                        <a class="uk-link-heading" href="kegiatan/<?= $newses[7]['slug'] ?>"><?= $newses[7]['title'] ?></a>
                                    </h4>
            ...
            <div class="uk-grid-match uk-grid-divider uk-child-width-1-1 uk-margin" uk-grid>
                ...
                ?>
                    <div>
                        <div class="uk-panel uk-margin">
                            <a href="kegiatan/<?= $news['slug'] ?>">
                                <img src="/images/kegiatan/<?= $news['images'] ?>" class="uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-background-cover">
                            </a>
                        ...
                        <div class="uk-panel uk-margin uk-text-center@m">
                            <div class="uk-flex-middle uk-child-width-1-1" uk-grid>
                                <div class="uk-flex-center">
                                    <a href="kegiatan/<?= $newses[7]['slug'] ?>">
                                        <img src="/images/kegiatan/<?= $newses[7]['images'] ?>" class="uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-background-cover">
                                    </a>
                                </div>
                                <div class="uk-width-expand">
                                    <h4 class="uk-margin-top uk-margin-remove-bottom">
