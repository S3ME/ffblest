    ...
    <div class="uk-container uk-container-expand">
        ...
        <form class="uk-margin uk-form-stacked" action="office/blog/new" method="post">
            <div class="uk-child-width-auto uk-flex-between uk-margin-medium" uk-grid>
                <div>
                    <h1 class="uk-h3 uk-heading-bullet uk-margin-remove">Formulir Tambah Artikel</h1>
                </div>
                ...
                <div class="uk-width-3-4">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <textarea class="uk-textarea uk-box-shadow-small uk-border-rounded" id="pendahuluan" rows="5" name="pendahuluan" placeholder="Masukkan Pendahuluan..." aria-label="Textarea" onchange="preview()"></textarea>
                        </div>
                    </div>
                ...
                <div class="uk-width-1-4">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <div id="images-container" class="uk-flex uk-flex-middle uk-flex-center"></div>
                            <script>
