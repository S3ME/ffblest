...
<!-- Tiny MCE Js  -->
<script src="https://cdn.tiny.cloud/1/6oowq9ven8af30z6vxip29mm3t3eep02xraxydkc8ah1b1gv/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
...
<section id="main" class="uk-section uk-section-small" hidden>
    <div class="uk-container uk-container-expand">
        ...
        <form class="uk-margin uk-form-stacked" action="office/blog/edit/<?=$blog['id']?>" method="post">
            <div class="uk-child-width-auto uk-flex-between uk-margin-medium" uk-grid>
                <div>
                ...
                <div class="uk-navbar-right">
                    <div class="uk-child-width-auto uk-grid-small uk-flex-center" uk-grid>
                        ...
                        <div><button class="uk-button uk-button-primary" type="submit">Simpan</button></div>
                    </div>
                </div>
            </div>
            <?= csrf_field() ?>
            <div class="uk-margin" uk-grid>
                <div class="uk-width-3-4">
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="pendahuluan">Pendahuluan</label>
                        <div class="uk-form-controls">
                            <textarea class="uk-textarea uk-box-shadow-small uk-border-rounded" id="pendahuluan" rows="5" name="pendahuluan" placeholder="Masukkan Pendahuluan..." aria-label="Textarea" onchange="preview()"><?=$blog['introtext']?></textarea>
                        </div>
                    </div>
                    ...
                    <script>
                        tinymce.init({
                            ...
                            file_picker_callback:       (cb, value, meta) => {
                                                            ...
                                                            input.setAttribute('accept', 'images/kegiatan/tinymce/*');
                ...
                <div class="uk-width-1-4">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-from-controls">
                            ...
                            <div id="images-container" class="uk-flex uk-flex-middle uk-flex-center">
                                <img src="images/kegiatan/<?=$blog['images']?>" style="max-height:100%; max-width:100%;" />
                            </div>
                            <script>
                                ...
                                UIkit.upload('.edit-upload', {
                                    ...
                                    complete: function () {
                                        ...
                                        image.setAttribute('src', 'images/kegiatan/'+filename);
                                        image.setAttribute('style', 'max-height:100%; max-width:100%;');

                                        imagecontainer.appendChild(image);

                                        $('#previewimage').attr('src', 'images/kegiatan/'+filename);
                    ...
                    <div class="uk-container">
                        <div class="uk-width-1-1 uk-margin" uk-scrollspy-class>
                            <picture class="uk-width-1-1">
                                <img id="previewimage" class="uk-width-1-1" src="images/kegiatan/<?=$blog['images']?>" alt="" />
                            </picture>
                        </div>
