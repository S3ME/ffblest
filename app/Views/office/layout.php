...
<html dir="ltr" lang="id" style="overflow-y:hidden;">
    ...
    <body>
        <header class="uk-navbar-container uk-section-secondary" style="background:#fff;">
            <div class="uk-container uk-container-expand">
                <nav uk-navbar>
                    <div class="uk-navbar-left">
                        <?php if ($ismobile) { ?>
                            <a uk-toggle href="#offcanvas" class="uk-navbar-toggle" role="button" aria-label="Open menu">
                                <div uk-navbar-toggle-icon style="color: #000;"></div>
                            </a>
                        <?php } else { ?>
                            <a class="uk-navbar-item uk-logo" href="office">
                                <img src="images/logo.png" loading="eager" width="115" height="50" uk-svg />
                            </a>
                        <?php } ?>
                    </div>
                    <?php if ($ismobile) { ?>
                        ...
                        <div class="uk-panel-scrollable" uk-height-viewport="offset-top:true; offset-bottom:#footer;" style="resize:none;">
                            <ul class="uk-nav uk-nav-primary">
                                ...
                                <li <?=(($uri->getSegment(1) === 'office') && ($uri->getSegment(2) === 'blog') ? 'class="uk-active"' : '')?>>
                                    <a href="office/blog"><span class="uk-margin-small-right" uk-icon="rss"></span> Kegiatan</a>
                                </li>
                                <li class="uk-nav-divider"></li>
                                <li <?=(($uri->getSegment(1) === 'office') && ($uri->getSegment(2) === 'gallery') ? 'class="uk-active"' : '')?>>
                                    <a href="office/gallery"><span class="uk-margin-small-right" uk-icon="image"></span> Galeri</a>
                                </li>
        ...
        <footer id="footer" class="uk-padding-small uk-section-secondary" style="background:#fff;">
            <div class="uk-container uk-container-expand">
                <div class="uk-child-width-auto uk-grid-small uk-flex-center uk-flex-between@m" uk-grid>
                    <div class="uk-text-meta Uk-text-center uk-text-left@m" style="color: #000;">
                        <?php
                    ...
                    <div class="uk-text-meta Uk-text-center uk-text-right@m" style="color: #000;">Developed by Dismas Banar Purnandi</div>
                </div>
            </div>
        </footer>
        <?php if ($ismobile) { ?>
